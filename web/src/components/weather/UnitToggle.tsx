...
export function UnitToggle({ unit, onToggle }: UnitToggleProps) {
  return (
    <button
      ...
      className="flex cursor-pointer items-center gap-1 rounded-full border border-white/10 bg-surface px-3 py-1.5 text-sm transition-all hover:bg-surface-hover focus:outline-none focus:ring-2 focus:ring-primary/20"
    >
